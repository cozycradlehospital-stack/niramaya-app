...
const styles = {
  ...
  shellPage: { minHeight: "100vh", display: "flex", flexDirection: "column", background: "#F6F5F1", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" },
  ...
  content: { flex: 1, overflowY: "auto", padding: "20px 16px 90px" },
